...
<div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
        <div class = "center">
        <h1>Hubo un error, vuelve a intentarlo.</h1>
      ...
      <div class="row">
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <p class="light">Seras sorteado a lo largo del evento para definir a cada uno de tus rivales, los cuales vendran de diferentes carreras pero un mismo objetivo.</p>
          </div>
        </div>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Pelea por tu titulo.</h5>
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Da lo mejor de ti y titulate.</h5>

            <p class="light">Ya sea que derrotes a tu jefe de carrera o simplemente obtengas una puntuación aprobatoria podrás recibir finalmente tu titulo.</p>
          </div>
        </div>
      </div>
